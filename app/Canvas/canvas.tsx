    ...
    <div className=" absolute inset-0 touch-none">
      ...
      <div className="absolute top-4 left-1/2 -translate-x-1/2  bg-blend-saturation border border-gray-700 rounded-2xl">
        <div className="flex gap-4  rounded-lg shadow-lg p-2">
          <button
            onClick={() => setSelectedShape(ShapeProp.rectangle)}
            className={` p-2 ${SelectedShape === ShapeProp.rectangle ? "bg-blue-700 rounded-lg" : ""}`}
          >
            <Square />
          </button>
          <button
            onClick={() => setSelectedShape(ShapeProp.circle)}
            className={` p-2 ${SelectedShape === ShapeProp.circle ? "bg-blue-700 rounded-lg" : ""}`}
          >
            <Circle />
          </button>
          <button
            onClick={() => setSelectedShape(ShapeProp.line)}
            className={` p-2 ${SelectedShape === ShapeProp.line ? "bg-blue-700 rounded-lg" : ""}`}
          >
            <Minus />
          </button>
          <button
            onClick={() => setSelectedShape(ShapeProp.FreeHandLine)}
            className={` p-2 ${SelectedShape === ShapeProp.FreeHandLine ? "bg-blue-700 rounded-lg" : ""}`}
          >
            <Pen />
          </button>
          <button
            onClick={() => setSelectedShape(ShapeProp.eraser)}
            className={` p-2 ${SelectedShape === ShapeProp.eraser ? "bg-blue-700 rounded-lg" : ""}`}
          >
            <Eraser />
          </button>
        </div>
